    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-20 pt-16 text-center md:pt-24">
        <div className="mx-auto max-w-3xl">
          <div className="mb-6">
            <img src="/logo.jpeg" alt="CellFlow" className="mx-auto h-24 w-24 rounded-2xl object-cover shadow-lg" />
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'PIX, cartão de crédito e boleto bancário. O plano custa R$ 150/mês (12x no cartão) ou R$ 1.800 à vista via PIX/boleto.',
              },
              {
